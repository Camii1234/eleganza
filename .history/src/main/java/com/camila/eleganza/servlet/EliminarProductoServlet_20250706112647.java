...
public class EliminarProductoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            String redirectUrl = "test-eliminar.jsp?mensaje=" + tipo + "&texto=" + mensajeCodificado;
            System.out.println("Redirigiendo a: " + redirectUrl);
            response.sendRedirect(redirectUrl);
        } catch (Exception e) {
            System.err.println("Error al codificar mensaje: " + e.getMessage());
            response.sendRedirect("test-eliminar.jsp?mensaje=" + tipo + "&texto=Error+al+procesar+solicitud");
        }
    }
