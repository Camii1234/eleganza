...
public class RegistroServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            System.out.println("documento: " + documentoStr);
            ...
            try {
                ...
                System.out.println("Documento convertido: " + documento);
            } catch (NumberFormatException e) {
                System.out.println("ERROR: Documento no es un número válido");
            ...
            if (usuarioDAO.existeIdUsuario(documento)) {
                System.out.println("ERROR: ID de usuario ya existe");
            ...
            System.out.println("Intentando registrar usuario: " + nuevoUsuario.toString());
