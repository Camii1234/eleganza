...
public class RegistroServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try {
            ...
            // Validar longitud máxima de contraseña (campo BD es varchar(15))
            if (password.length() > 15) {
                System.out.println("ERROR: Contraseña muy larga");
                request.setAttribute("error", "La contraseña no puede tener más de 15 caracteres");
                forwardToRegistro(request, response);
                return;
            }
