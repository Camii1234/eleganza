...
public class AgregarProductoServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Log para debugging - verificar qué valores llegan
            System.out.println("=== DEBUGGING FORM DATA ===");
            ...
            // Manejar talla - si no se especificó, usar "Única"
            ...
            // Log del objeto producto creado
            System.out.println("=== PRODUCTO CREADO ===");
            System.out.println(producto.toString());
            System.out.println("Imagen size: " + (imagenBytes != null ? imagenBytes.length + " bytes" : "null"));
            System.out.println("======================");
            
            // Guardar en la base de datos
            boolean resultado = productoDAO.agregarProducto(producto);
            
            System.out.println("Resultado de agregar producto: " + resultado);
