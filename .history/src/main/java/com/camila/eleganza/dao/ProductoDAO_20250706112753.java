...
public class ProductoDAO {
    ...
    public Producto getProductoById(int id) {
        ...
        String sql = "SELECT * FROM producto WHERE idProducto = ? AND estado = 'Activo'";
    ...
    public boolean deleteProducto(int id) {
        ...
        System.out.println("ProductoDAO: Intentando eliminar producto con ID: " + id);
        ...
        try (Connection conn = ConexionBD.getConnection();
            ...
            System.out.println("ProductoDAO: Filas afectadas: " + result);
            return result > 0;
