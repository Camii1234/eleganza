...
public class ProductoDAO {
    ...
    // Método para agregar un producto a la base de datos (incluyendo imagen)
    public boolean agregarProducto(Producto producto) {
        String sql = "INSERT INTO producto (nombre, precio, talla, categoria, stock, estado, descripcion, imagen) " +
                    "VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = ConexionBD.getConnection();
            ...
            return rowsAffected > 0; // Devuelve true si al menos una fila se insertó correctamente
