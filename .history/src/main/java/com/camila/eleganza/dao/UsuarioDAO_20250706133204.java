...
public class UsuarioDAO {
    ...
    public boolean agregarUsuario(Usuario usuario) {
        // Incluir el campo documento en la inserción
        String sql = "INSERT INTO usuario (idUsuario, nombre, correo, password, telefono, calle, ciudad, codigoPostal, pais, documento) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        
        try (Connection conn = ConexionBD.getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {

            ps.setString(1, usuario.getDocumento()); // El documento va en idUsuario
            ...
            ps.setString(10, usuario.getDocumento()); // También guardar documento en el campo documento
    ...
    public Usuario buscarUsuarioPorCorreo(String correo) {
        ...
        try (Connection conn = ConexionBD.getConnection();
            ...
            if (rs.next()) {
                ...
                // Solo agregar documento si existe la columna
                try {
                    usuario.setDocumento(rs.getString("documento"));
                } catch (SQLException e) {
                    // La columna documento no existe, no hacer nada
                }
