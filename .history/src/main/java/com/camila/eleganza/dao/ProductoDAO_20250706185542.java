...
public class ProductoDAO {
    ...
    public boolean agregarProducto(Producto producto) {
        ...
        System.out.println("=== DAO: Intentando agregar producto ===");
        System.out.println("SQL: " + sql);
        System.out.println("Producto a insertar: " + producto.toString());
        ...
        try (Connection conn = ConexionBD.getConnection();
            ...
            System.out.println("Parámetros establecidos en PreparedStatement");
            System.out.println("1. Nombre: " + producto.getNombre());
            System.out.println("2. Precio: " + producto.getPrecio());
            System.out.println("3. Talla: " + producto.getTalla());
            System.out.println("4. Categoria: " + producto.getCategoria());
            System.out.println("5. Stock: " + producto.getStock());
            System.out.println("6. Estado: " + producto.getEstado());
            System.out.println("7. Imagen: " + (producto.getImagen() != null ? "Si (" + producto.getImagen().length + " bytes)" : "No"));
            System.out.println("8. Descripcion: " + producto.getDescripcion());
