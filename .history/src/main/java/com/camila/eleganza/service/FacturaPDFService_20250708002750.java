...
public class FacturaPDFService {
    ...
    private static final DeviceRgb ELEGANZA_BLUE = new DeviceRgb(13, 110, 253);
    private static final DeviceRgb ELEGANZA_GOLD = new DeviceRgb(255, 193, 7);
    private static final DeviceRgb LIGHT_GRAY = new DeviceRgb(248, 249, 250);
    private static final DeviceRgb DARK_GRAY = new DeviceRgb(108, 117, 125);
    ...
    public byte[] generarFacturaPDF(Factura factura) throws IOException {
        ...
        try (PdfWriter writer = new PdfWriter(outputStream);
            ...
            agregarEncabezadoEmpresa(document, fontBold);
