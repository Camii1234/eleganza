...
<html lang="es">
    <head>
        ...
        <style>
            body, h1, h2, h3, h4, h5, h6, .display-5, .fw-bolder {
                font-family: 'Playfair Display', serif !important;
            }
            .text-primary, .bg-primary, .btn-primary, .feature.bg-primary, .text-primary.mx-1 {
                color: #fd6eb4 !important;
                background-color: #fd6eb4 !important;
                border-color: #fd6eb4 !important;
            }
            ...
            .btn-primary:hover, .btn-outline-primary:hover {
                background-color: #f078c8 !important;
                border-color: #f078c8 !important;
            }
            .feature.bg-primary {
                background: linear-gradient(135deg, #fd6eb4 60%, #f078c8 100%) !important;
            }
            .bg-gradient {
                background: linear-gradient(135deg, #fd6eb4 60%, #ffb4dc 100%) !important;
            }
            .btn-outline-light {
                color: #fd6eb4 !important;
                border-color: #fd6eb4 !important;
